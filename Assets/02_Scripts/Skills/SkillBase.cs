...
public abstract class SkillBase : ScriptableObject
{
    ...
    public abstract IEnumerator TargetMode(SimulationController controller, IReadOnlyList<PieceBase> allPieces);

    /// <summary>
    /// 스킬 효과를 코루틴으로 실행한다.
    /// </summary>
    public abstract void Execute(SimulationController controller, IReadOnlyList<PieceBase> allPieces);
